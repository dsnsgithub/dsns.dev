...
## My First Day
This operating system has a learning curve, with the philospophy being that if you take twenty minutes learning how to use your operating system more efficiently, it will pay dividends over the years using your computer. While Windows and macOS cater towards the general public, who don't want to read a manual to simply use their computer, Omarchy is definitely a "power user" distribution, for those who love computers.
...
Even before Omarchy, I transitioned away from using the mouse or trackpad for most tasks as especially on a laptop, using a trackpad is incredibly slow for my needs. Omarchy felt like an operating system molded around the workflow I already use. I understand that most people don't have the time nor care enough to use these shortcuts, but I agree with the general sentiment that twenty minutes learning how to use your computer more efficiently can pay off significantly in both efficiency and wrist pain.

## The Learning Curve
Even though I was accustomed to many of the shortcuts, switching to Linux still has a learning curve, from installing apps with the AUR, moving windows across multiple desktops, and the idea of "alt-tab" generally not moving windows behind or in front of others.
